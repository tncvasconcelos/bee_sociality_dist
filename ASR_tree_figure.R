...
# # ============================================================================
# # This script visualizes a circular bee phylogeny with branches colored by
# # ancestral state reconstruction (ASR), a trait ring at the tips, and labeled
# # families with MRCA node dots.
# # ==============================================================================
# 
# # ------------------------------------------------------------------------------
# # Setup
...
# 
# # Match trait order to tree tip order
# traits <- traits[match(tree$tip.label, traits$tips), ]
# 
# # Create combined trait category
...
# 
# # Set color palette for trait combinations
...
# 
# # Key to match ASR state labels to trait combinations
# asr_state_key <- c(
...
# )
# 
# # Map ASR state to branches (only if likelihood > 0.5)
# n_tips <- length(tree$tip.label)
# branch_colors <- rep("gray80", nrow(tree$edge))  # Default: gray
# 
...
# 
# #-------------------------------------------------------------------------------
# # Define functions for polar <-> Cartesian conversion
# #-------------------------------------------------------------------------------
...
# 
# # Convert tip coordinates to polar
# p_original <- toPolar(tips_xx, tips_yy)
# 
# #-------------------------------------------------------------------------------
# # Add circular trait ring at tips
# #-------------------------------------------------------------------------------
# ri <- 0.2         # radial increment between rings
# len <- 15         # width of the trait ring
# space <- 4        # buffer space before and after the ring
# 
...
# 
# #-------------------------------------------------------------------------------
# # Add family labels aligned horizontally just outside the ring
# #-------------------------------------------------------------------------------
...
# 
# #-------------------------------------------------------------------------------
# # Add legend for trait combinations
# #-------------------------------------------------------------------------------
# legend("topleft",
...
#        cex = 0.6,
#        x.intersp = 1.3,
#        inset = c(-0.08, -0.06))  # left and upward
# 
# #-------------------------------------------------------------------------------
# # Add straight radial time axis (reversed, with period labels)
# #-------------------------------------------------------------------------------
# 
# # Define time values (assume ultrametric tree)
# tree_height <- max(nodeHeights(tree))  # or use `max(branching.times(tree))`
# 
# # Set axis position (angle = 0 = horizontal right)
# theta_axis <- 0
# 
# # Convert time to radial distance (reverse)
# n_ticks <- 5
...
#   
#   text(label_coords$x, label_coords$y + 0.03 * max(radii),
#        labels = periods$name[i], cex = 0.5, font = 3)
# }
# 
# 
# dev.off()
# ============================================================================
# Circular Phylogeny: ASR Branch Coloring + Trait Ring + Family Labels + Time
# ============================================================================

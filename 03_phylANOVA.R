...
pdf("plots/nesting_boxplots_all_vars_kruskal.pdf")
sink("nesting_result_kruskal.txt")
...
pdf("plots/sociality_boxplots_all_vars_kruskal.pdf")
sink("sociality_result_kruskal.txt") # prints results to text file

...
all_model_results <- subset(all_model_results, grepl("_bio4", all_model_results))
model_names <- gsub(".Rsave","",all_model_results)
...
boxplot(average_pars$expected_mean~average_pars$tip_state, xlab="tip state", ylab="expected mean (temperature seasonality)")

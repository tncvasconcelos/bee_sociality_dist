...
setwd(wd)
results_wd <- file.path(wd, "results/hOUwie")
...
for (bio in bio_vars) {
  ...
  csv_table_path <- file.path(results_wd, paste0("hOUwie_model_table_", bio, ".csv"))
  csv_pars_path  <- file.path(results_wd, paste0("hOUwie_average_pars_", bio, ".csv"))
  plot_mean_path <- file.path(results_wd, paste0("hOUwie_boxplot_", bio, "_mean.png"))
  plot_var_path  <- file.path(results_wd, paste0("hOUwie_boxplot_", bio, "_variance.png"))
...
bio1 <- read.csv(file.path(results_wd, "hOUwie_average_pars_bio1.csv"))
bio4 <- read.csv(file.path(results_wd, "hOUwie_average_pars_bio4.csv"))
bio12 <- read.csv(file.path(results_wd, "hOUwie_average_pars_bio12.csv"))
bio15 <- read.csv(file.path(results_wd, "hOUwie_average_pars_bio15.csv"))
...
# Save
ggsave(
  filename = file.path(results_wd, "hOUwie_combined_means.png"),
...
ggsave(
  filename = file.path(results_wd, "hOUwie_combined_means.pdf"),
  plot = combined_mean_plot,
  width = 12,
  height = 12
)
